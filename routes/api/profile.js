	...
	const profileFields = {};
    	...
    	try {
    		...
    		if (profile) {
    			...
    			//look for profile and update if found 
    	...
    	//if profile not found create and save 
...
async (req,res) => {
	...
	//create object with required data submitted
	...
	//fetch profile from database to add experience to 
...
async (req,res) => {
	...
	//fetch profile from database to add education 
